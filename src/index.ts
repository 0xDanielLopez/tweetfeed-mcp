		...
		inputSchema: {
			...
			properties: {
				...
				tag: {
					type: "string",
					description:
						"Optional: filter by tag, case-insensitive substring match. Examples: 'phishing', 'cobaltstrike', 'ransomware', 'APT', 'Lockbit'. 94 tags exist - see https://tweetfeed.live/ for the live taxonomy.",
				},
				type: {
					type: "string",
		...
		inputSchema: {
			...
			properties: {
				tag: {
					type: "string",
					description:
						"Tag to look up (e.g. 'phishing', 'CobaltStrike', 'lockbit'). Case-insensitive. The leading '#' is optional. 94 tags exist - see https://tweetfeed.live/tags/ for the full list.",
				},
				limit: {
					type: "number",
